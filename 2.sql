...
select * 
from film 
where  replacement_cost  12.99 between 12.99 and 16.99 and replacement_cost != 16.99;
...
select *
from film 
where  rental_rate in(0.99, 2.99, 4.99) and replacement_cost in (12.99, 15.99, 28.9);
